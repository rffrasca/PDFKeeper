...
Public Class DocumentUtilService
    Implements IDocumentUtilService
    ...
    Public Sub RebuildFullTextSearchIndex() Implements IDocumentUtilService.RebuildFullTextSearchIndex
        repository.RebuildFullTextSearchIndex()
    End Sub
End Class
