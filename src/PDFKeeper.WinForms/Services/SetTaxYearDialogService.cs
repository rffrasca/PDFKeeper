...
{
    /// <summary>
    /// <see cref="SetTaxYearForm"/> implementation of the <see cref="IDialogService"/> interface.
    /// </summary> 
    internal sealed class SetTaxYearDialogService : IDialogService
    {
        ...
        /// </param>
        public SetTaxYearDialogService(
        ...
        {
            using (var dialog = new SetTaxYearForm(helpFileResolver, messageBoxService))
            {
