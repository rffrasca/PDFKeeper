...
{
    internal partial class SetAuthorForm : Form
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetAuthorForm"/> class.
        /// </summary>
        /// <param name="messageBoxService">A dialog service that displays messages.</param>
        public SetAuthorForm(IMessageBoxService messageBoxService)
        {
            InitializeComponent();
