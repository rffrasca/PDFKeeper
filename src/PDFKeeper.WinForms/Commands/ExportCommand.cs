...
namespace PDFKeeper.WinForms.Commands
{
    public class ExportCommand : ICommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ExportCommand class that exports all checked
        /// documents when executed.
        /// </summary>
        /// <param name="presenter">The MainPresenter instance.</param>
        public ExportCommand(MainPresenter presenter)
        {
        ...
        public void Execute()
        {
            presenter.ExportEachSelectedDocument();
        }
    }
}
