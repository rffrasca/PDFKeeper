...
namespace PDFKeeper.WinForms.Commands
{
    public class TextBoxEnterCommand : TextBoxFocusCommandBase, ICommand
    {
        ...
        /// state in the <see cref="MainViewModel"/> for a <see cref="TextBox"/> <c>Enter</c> event
        /// when executed.
        /// </summary>
        ...
        {
            SetTextBoxFocusedState(true);
            viewModel.SetStateOnTextBoxEnterEventCommand.Execute(textBox.CanUndo);
        }
    }
}
