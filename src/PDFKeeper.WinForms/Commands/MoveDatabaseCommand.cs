...
namespace PDFKeeper.WinForms.Commands
{
    public class MoveDatabaseCommand : ICommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MoveDatabaseCommand class that will move the local
        /// SQLite database to a new location when executed.
        /// </summary>
        /// <param name="presenter">The MainPresenter instance.</param>
        public MoveDatabaseCommand(MainPresenter presenter)
        {
