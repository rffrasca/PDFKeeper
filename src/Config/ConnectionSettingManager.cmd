...
rem * Copyright (C) 2009-2025 Robert F. Frasca
rem *
...
set MenuChoice3=3. Delete Oracle ODP.NET folder path
set MenuChoice4=4. Delete Oracle Wallet folder path
...
if %ERRORLEVEL%==3 goto DeleteOracleOdpNetPath
if %ERRORLEVEL%==4 goto DeleteOracleWalletPath
