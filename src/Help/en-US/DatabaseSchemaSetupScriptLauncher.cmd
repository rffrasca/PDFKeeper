@echo off
rem ***************************************************************************
rem * PDFKeeper -- Open Source PDF Document Storage and Management
rem * Copyright (C) 2009-2020  Robert F. Frasca
rem *
...
set MenuChoice2=2. Oracle Database (for upgrading from PDFKeeper version 4.1.0 or earlier)
