...
Public Class RestoreCommand
    ...
    ''' <summary>
    ''' Initializes a new instance of the RestoreCommand class that restores the text in the Notes
    ''' text box with the Notes stored in the database when executed.
    ''' </summary>
