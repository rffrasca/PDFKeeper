...
Public Class ToolBarToggleCommand
    Implements ICommand
    Private ReadOnly view As MainView

    ''' <summary>
    ''' Initializes a new instance of the ToolBarToggleCommand class that toggles the View Tool Bar
    ''' menu item Checked state which controls the ToolStrip Visible state when executed.
    ''' </summary>
