...
Public Class SetPreviewImageCommand
    Implements ICommand
    Private ReadOnly presenter As MainPresenter

    ''' <summary>
    ''' Initializes a new instance of the SetPreviewImageCommand class that sets the preview image
    ''' when executed.
    ''' </summary>
    ...
    Public Sub Execute() Implements ICommand.Execute
        presenter.SetPreviewImage(My.Settings.PreviewPixelDensity)
    End Sub
End Class
