...
Public Class MoveDatabaseCommand
    Implements ICommand
    Private ReadOnly presenter As MainPresenter

    ''' <summary>
    ''' Initializes a new instance of the MoveDatabaseCommand class that will move the local SQLite
    ''' database to a new location when executed.
    ''' </summary>
