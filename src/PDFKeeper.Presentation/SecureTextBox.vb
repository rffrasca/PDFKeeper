...
#Enable Warning CA2213 ' Disposable fields should be disposed
    ...
    ''' </summary>
    ''' <returns>Text encrypted as a secure string.</returns>
    ...
    Protected Overrides Sub OnKeyDown(ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        If e.KeyCode = Keys.Delete Then
            ...
            ElseIf Me.SelectionStart < Me.Text.Length Then
                _SecureText.RemoveAt(Me.SelectionStart)
            End If
    ...
    Protected Overrides Sub OnKeyPress(ByVal e As System.Windows.Forms.KeyPressEventArgs)
        ...
        If e.KeyChar = ControlChars.Back Then
            ...
            ElseIf Me.SelectionStart > 0 Then
                _SecureText.RemoveAt(Me.SelectionStart - 1)
        ...
        Else
            ...
            _SecureText.InsertAt(Me.SelectionStart, e.KeyChar)
    ...
    Private Sub SetTextBoxTextAndCursorPosition(ByVal cursorPosition As Integer)
        ...
        Me.Text = New String(CChar("*"), _SecureText.Length)
