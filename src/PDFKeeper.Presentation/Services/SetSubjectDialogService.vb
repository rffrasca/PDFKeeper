...
Public Class SetSubjectDialogService
    ...
    Public Function ShowDialog() As String Implements IDialogService.ShowDialog
        Using dialog = New SetSubjectView
            dialog.ShowDialog()
            If dialog.DialogResult.Equals(DialogResult.OK) Then
                If dialog.SubjectUserControl.Subject.Length > 0 Then
                    Return dialog.SubjectUserControl.Subject
                Else
                    Dim messageBoxService = New MessageBoxService
                    messageBoxService.ShowMessage(My.Resources.SubjectCannotBeBlank, True)
                    Return Nothing
                End If
            Else
                Return Nothing
