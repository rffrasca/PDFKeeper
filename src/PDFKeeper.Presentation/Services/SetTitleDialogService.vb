...
Public Class SetTitleDialogService
    ...
    Public Function ShowDialog() As String Implements IDialogService.ShowDialog
        Using dialog = New SetTitleView
            dialog.ShowDialog()
            If dialog.DialogResult.Equals(DialogResult.OK) Then
                If dialog.Title.Length > 0 Then
                    Return dialog.Title
                Else
                    Dim messageBoxService = New MessageBoxService
                    messageBoxService.ShowMessage(My.Resources.TitleCannotBeBlank, True)
                    Return Nothing
                End If
            Else
                Return Nothing
