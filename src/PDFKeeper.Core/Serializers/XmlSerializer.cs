...
namespace PDFKeeper.Core.Serializers
{
    ...
    internal static class XmlSerializer
    {
        ...
        /// </returns>
        internal static T DeserializeFromFile<T>(string xmlFilePath)
        {
        ...
        /// <summary>
        /// Serializes the specified object to an XML file using indentation and
        /// entitized new lines.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// </param>
        internal static void SerializeToFile<T>(T obj, string xmlFilePath)
        {
