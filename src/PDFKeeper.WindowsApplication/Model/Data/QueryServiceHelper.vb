...
'******************************************************************************
Public NotInheritable Class QueryServiceHelper
    Private Sub New()
    ...
    <System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", _
        ...
        MessageId:="0#")> _
    Public Shared Sub SetQueryService(ByRef queryService As IQueryService)
        Dim credential As DatabaseCredential = DatabaseCredential.Instance
        If credential.DatabaseSystem = "Oracle" Then
            queryService = New OracleQueryService
        End If
    End Sub
End Class
