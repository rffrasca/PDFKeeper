...
'******************************************************************************
Public NotInheritable Class NonQueryServiceHelper
    Private Sub New()
    ...
    <System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", _
        ...
        MessageId:="0#")> _
    Public Shared Sub SetNonQueryService(ByRef nonQueryService As INonQueryService)
        Dim credential As DatabaseCredential = DatabaseCredential.Instance
        If credential.DatabaseSystem = "Oracle" Then
            nonQueryService = New OracleNonQueryService
        End If
    End Sub
End Class
