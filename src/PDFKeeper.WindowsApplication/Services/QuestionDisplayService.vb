...
Public Class QuestionDisplayService
    Implements IQuestionDisplayService
    Private options As MessageBoxOptions
    Private buttons As MessageBoxButtons

    Public Function Show(question As String, cancelVisible As Boolean) As DialogResult Implements IQuestionDisplayService.Show
        SetOptions()
    ...
    Public Function ShowFormClosingPrompt() As Boolean Implements IQuestionDisplayService.ShowFormClosingPrompt
