...
'******************************************************************************
Public Class MainViewToolStripStatePresenter
    Private toolStrip As IMainViewToolStripState

    ' List contains ToolStrip short names and Enabled state.
    Dim shortNames As New GenericDictionaryList(Of String, Boolean)

    Public Sub New(toolStrip As IMainViewToolStripState)
    ...
    Public Sub SetSearchResultsViewRowCountChangedState(ByVal rowCount As Integer, _
