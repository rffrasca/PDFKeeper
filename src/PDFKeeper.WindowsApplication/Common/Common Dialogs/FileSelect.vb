...
Public Class FileSelect
    Implements IFileSelect, IDisposable
    Private fileDialog As FileDialog
    Private m_FileName As String
    Private m_Filter As String

    Public Property FileName As String Implements IFileSelect.FileName
        Get
            Return m_FileName
        End Get
        Set(value As String)
    ...
    Public Property Filter As String Implements IFileSelect.Filter
        Get
            Return m_Filter
        End Get
        Set(value As String)
    ...
    Public Function ShowOpen() As String Implements IFileSelect.ShowOpen
        fileDialog = New OpenFileDialog
        Return ShowDialog()
    End Function

    Public Function ShowSave() As String Implements IFileSelect.ShowSave
