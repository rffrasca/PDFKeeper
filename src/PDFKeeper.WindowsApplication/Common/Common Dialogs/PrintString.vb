...
Public Class PrintString
    ...
    Public Sub Print() Implements IPrintString.Print
    ...
    Public Sub PrintPreview(printPreviewFormSize As Size) Implements IPrintString.PrintPreview
