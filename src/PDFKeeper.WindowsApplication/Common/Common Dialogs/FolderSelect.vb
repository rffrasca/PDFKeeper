...
Public Class FolderSelect
    Implements IFolderSelect, IDisposable
    Private folderBrowser As New FolderBrowserDialog

    Public Property Description As String Implements IFolderSelect.Description
        Get
    ...
    Public Function Show() As String Implements IFolderSelect.Show
