...
Build Instructions for version 6.x.x (in development/not building) is available [here](https://github.com/rffrasca/PDFKeeper/blob/master/docs/Build-Instructions-6.x.x.md).
