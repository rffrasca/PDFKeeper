...
![Logo](https://github.com/rffrasca/PDFKeeper/blob/master/docs/Screenshot-6.0.0.png)
Screenshot of main window in version 6.0.x.
...
These features are available in version 6.0.x. 
