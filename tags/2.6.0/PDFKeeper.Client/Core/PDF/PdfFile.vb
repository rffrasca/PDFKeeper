...
Public Class PdfFile
	...
	''' <summary>
	''' This function will return "True" or "False" if the filename of the PDF
	''' file object ends in ".modified_by_pdfkeeper.pdf".
	''' </summary>
	''' <returns>True or False</returns>
	Public Function ModifiedByPdfKeeper As Boolean
		Dim fileString As String = ".modified_by_pdfkeeper.pdf"
		If pdfFile.Length < fileString.Length Then
			Return False
		Else
			If pdfFile.Substring(pdfFile.Length - fileString.Length) = _
												  fileString Then
				Return True
			Else
				Return False
