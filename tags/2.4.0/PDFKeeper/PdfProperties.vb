...
Public Class PdfProperties
	...
	Public Function Save() As Byte
		...
		Dim randNum1 As String = oRandom.Next
		modPdfFile = pdfFile & "." & randNum1.Substring(0,3)
		...
		Dim randNum2 As String = oRandom.Next
		Dim bakPdfFile As String = pdfFile & "." & randNum2.Substring(0,3)
		Try
			FileSystem.Rename(pdfFile, bakPdfFile)
			FileSystem.Rename(modPdfFile, pdfFile)
			Dim oMessageDialog As New _
				 MessageDialog("The original version " & _
							   "of " & pdfFile & " has been saved " & _
							   "as " & bakPdfFile)
