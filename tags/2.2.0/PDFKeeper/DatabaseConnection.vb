...
Public Class DatabaseConnection
	...
	Friend objOracleConnection As New OracleConnection
	...
	Public Function Open() As Byte
		...
		Try
			objOracleConnection.ConnectionString = Marshal.PtrToStringBSTR(connectionStringPtr)
