...
if version = "" or left(version,5) <> "4.0.0" then
	message = "Open Object Rexx 4.0.0 is not installed! " & _
		  "To correct, refer to the Installation " & _
		  "section of the Installation / Quick Start Guide."
...
objShell.Run "rexxhide.exe " & "pdfsearch.rex"
