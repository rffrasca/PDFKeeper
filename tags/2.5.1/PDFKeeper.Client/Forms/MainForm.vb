...
Public Partial Class MainForm
	...
	Private Sub FileSystemWatcherEditorCreated(sender As Object, e As FileSystemEventArgs)
		...
		If e.FullPath.Length < fileString.Length Then
			validate = False
		End If
		If validate = True Then
			If e.FullPath.Substring(e.FullPath.Length - fileString.Length) = _
														fileString Then
				Exit Sub
			End If
		End If
	...
	Private Sub MainFormClosing(sender As Object, e As FormClosingEventArgs)
		Dim oWindow As New Window(InfoPropEditTitle)
		If BackgroundWorkersBusy Or oWindow.IsOpen Or watcherEditorBusy Then
			e.Cancel = True
		End If
	End Sub
