...
Friend Class NativeMethods
	Private Sub New()
		' Private constructor required by FxCop. (CA1812)
	End Sub
	...
	''' <summary>
	''' This function is used to set the title bar text for the window
	''' specified by hWnd. hWnd is the handle of the specified window.
	''' </summary>
	''' <param name="hwnd"></param>
