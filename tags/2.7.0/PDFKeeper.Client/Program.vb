...
Namespace My
	Partial Class MyApplication
		Public Sub New()
			...
			folders.Add(DocsDir)
			folders.Add(ArchiveDir)
			For Each folder As String In folders
				Dim oFolderIO1 As New FolderIO(folder)
				If oFolderIO1.Create = 1 Then
					Environment.Exit(1)
				End If
			Next
			Dim oFolderIO2 As New FolderIO(OldCacheDir)
			If oFolderIO2.Delete = 1 Then
				Environment.Exit(1)
			End If
