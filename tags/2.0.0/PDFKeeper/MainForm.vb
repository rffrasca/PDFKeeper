...
Public Partial Class MainForm
	...
	''' <param name="sender"></param>
	''' <param name="e"></param>
	Private Sub TextBoxSearchTextTextChanged(sender As Object, e As EventArgs)
		...
		textBoxSearchText.Text = textBoxSearchText.Text.TrimStart
		If textBoxSearchText.Text.Length = 0 Then
			Exit Sub
		End If
		If textBoxSearchText.Text.IndexOf("*", StringComparison.Ordinal) <> -1 Then
			errorMessage = "Database does not support the use of * " & _
				  		   ...
				  		   "User Guide."
			errorProvider.SetError(textBoxSearchText, errorMessage)
			textBoxSearchText.Select
			Exit Sub
		End If
		If textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "MINUS" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "MINUS " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "NEAR" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "NEAR " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "NOT" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "NOT " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "AND" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "AND " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "EQUIV" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "EQUIV " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "WITHIN" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "WITHIN " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "OR" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "OR " Or _
 		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "ACCUM" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "ACCUM " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "FUZZY" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "FUZZY " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "ABOUT" Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "ABOUT " Or _
		   textBoxSearchText.Text.ToUpper(CultureInfo.InvariantCulture) = "ABOUT()" Or _
		   textBoxSearchText.Text.IndexOf("{}", StringComparison.Ordinal) <> -1 Or _
		   textBoxSearchText.Text.IndexOf("()", StringComparison.Ordinal) <> -1 Or _
		   textBoxSearchText.Text.Substring(0,1) = "=" Or _
		   textBoxSearchText.Text.Substring(0,1) = ";" Or _
		   textBoxSearchText.Text.Substring(0,1) = ">" Or _
		   textBoxSearchText.Text.Substring(0,1) = "-" Or _
		   textBoxSearchText.Text.Substring(0,1) = "~" Or _
		   ...
		   textBoxSearchText.Text.Substring(0,1) = "{" Or _
		   textBoxSearchText.Text.Substring(0,1) = "(" Or _
		   textBoxSearchText.Text = "?" Or _
		   textBoxSearchText.Text = "$" Then
	...
	''' listview, sorted by the selected column.
	''' </summary>
	''' <param name="sender"></param>
	''' <param name="e"></param>
	...
	Private Sub UpdateListCountStatusBar
		toolStripStatusLabel.Text = listViewDocs.Items.Count & _
								  " document(s)"
	End Sub
	...
	''' <summary>
	''' This subroutine will call a subroutine to delete temporary files,
