...
LicenseFile=H:\My Documents\SharpDevelop Projects\PDFKeeper\COPYING.txt
OutputDir=H:\My Documents\SharpDevelop Projects\PDFKeeper
OutputBaseFilename=PDFKeeper-2.0.0
SetupIconFile=H:\My Documents\SharpDevelop Projects\PDFKeeper\Graphics\Logo.ico
Compression=lzma
...
AlwaysRestart=false
AppCopyright=© 2009-2010 Robert F. Frasca
AppVersion=2.0.0
AppContact=
VersionInfoCompany=Robert F. Frasca
VersionInfoCopyright=© 2009-2010 Robert F. Frasca
...
[Files]
Source: THIRDPARTYPLUGINS.txt; DestDir: {app}
...
Source: PlugIns\SumatraPDF.exe; DestDir: {app}
Source: PlugIns\itextsharp.dll; DestDir: {app}
...
begin
	...
	// PDFKeeper 1.0.0 or 1.1.0 cannot be upgraded and must be uninstalled
